...
```python
{{ include_file_content("/autoalbument/examples/cifar10/dataset.py") }}
```

## search.yaml

```yaml
{{ include_file_content("/autoalbument/examples/cifar10/search.yaml") }}
```

## model.py

```python
{{ include_file_content("/autoalbument/examples/cifar10/model.py") }}
```
